...
function MainComponent() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const errorMessages = {
        EmailCreateAccount:
          "Este email já está em uso ou não pode ser utilizado.",
        CredentialsSignin: "Erro ao criar conta. Tente novamente.",
      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-base font-medium text-gray-700 transition-colors hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
          >
